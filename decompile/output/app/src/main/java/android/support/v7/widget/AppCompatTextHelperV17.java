  ...
  extends AppCompatTextHelper
{
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (localTypedArray.hasValue(R.styleable.AppCompatTextHelper_android_drawableStart)) {
      mDrawableStartTint = createTintInfo(localContext, localAppCompatDrawableManager, localTypedArray.getResourceId(R.styleable.AppCompatTextHelper_android_drawableStart, 0));
    }
    if (localTypedArray.hasValue(R.styleable.AppCompatTextHelper_android_drawableEnd)) {
      mDrawableEndTint = createTintInfo(localContext, localAppCompatDrawableManager, localTypedArray.getResourceId(R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
    }
