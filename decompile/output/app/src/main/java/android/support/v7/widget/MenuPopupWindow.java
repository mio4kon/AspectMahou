    ...
    extends DropDownListView
  {
    ...
    public boolean onHoverEvent(MotionEvent paramMotionEvent)
    {
      ...
      for (;;)
      {
        ...
        MenuItem localMenuItem = mHoveredMenuItem;
        if (localMenuItem != localMenuItemImpl)
        {
          MenuBuilder localMenuBuilder = localMenuAdapter.getAdapterMenu();
          if (localMenuItem != null) {
            mHoverListener.onItemHoverExit(localMenuBuilder, localMenuItem);
          }
          mHoveredMenuItem = localMenuItemImpl;
          if (localMenuItemImpl != null) {
            mHoverListener.onItemHoverEnter(localMenuBuilder, localMenuItemImpl);
          }
        }
