...
public final class MediaBrowserCompat
{
    ...
    extends ResultReceiver
  {
    ...
    protected void onReceiveResult(int paramInt, Bundle paramBundle)
    {
      ...
      {
        mCallback.onItemLoaded((MediaBrowserCompat.MediaItem)localParcelable);
        return;
      }
      mCallback.onError(mMediaId);
    }
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
  {
    ...
    public MediaBrowserImplApi21(Context paramContext, ComponentName paramComponentName, MediaBrowserCompat.ConnectionCallback paramConnectionCallback, Bundle paramBundle)
    {
      if (Build.VERSION.SDK_INT < 25)
      {
        ...
        mRootHints = new Bundle(paramBundle);
    ...
    public void onConnected()
    {
      Bundle localBundle = MediaBrowserCompatApi21.getExtras(mBrowserObj);
      if (localBundle == null) {}
    ...
    public void onLoadChildren(Messenger paramMessenger, String paramString, List paramList, Bundle paramBundle)
    {
      ...
      do
      {
        ...
        {
          return;
          localSubscription = (MediaBrowserCompat.Subscription)mSubscriptions.get(paramString);
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl
  {
    ...
    public void connect()
    {
      ...
      try
      {
        boolean bool2 = mContext.bindService(localIntent, mServiceConnection, 1);
        bool1 = bool2;
      }
        ...
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            for (int i = 0; i < localList1.size(); i++) {
              mServiceBinderWrapper.addSubscription(str, MediaBrowserCompat.SubscriptionCallback.access$000((MediaBrowserCompat.SubscriptionCallback)localList1.get(i)), (Bundle)localList2.get(i), mCallbacksMessenger);
            }
          }
          return;
        }
  ...
  public static abstract class SubscriptionCallback
  {
      ...
      implements MediaBrowserCompatApi21.SubscriptionCallback
    {
      ...
      public void onChildrenLoaded(@NonNull String paramString, List<?> paramList)
      {
        ...
        for (MediaBrowserCompat.Subscription localSubscription = null; localSubscription == null; localSubscription = (MediaBrowserCompat.Subscription)mSubscriptionRef.get())
        {
        ...
        for (;;)
        {
          ...
          break;
          label114:
          onChildrenLoaded(paramString, applyOptions(localList1, localBundle), localBundle);
        }
      }
