...
public class ViewCompat
{
    ...
    extends ViewCompat.HCViewCompatImpl
  {
    ...
    public ViewPropertyAnimatorCompat animate(View paramView)
    {
      ...
      ViewPropertyAnimatorCompat localViewPropertyAnimatorCompat = (ViewPropertyAnimatorCompat)mViewPropertyAnimatorCompatMap.get(paramView);
      if (localViewPropertyAnimatorCompat == null)
      {
        localViewPropertyAnimatorCompat = new ViewPropertyAnimatorCompat(paramView);
        mViewPropertyAnimatorCompatMap.put(paramView, localViewPropertyAnimatorCompat);
      }
