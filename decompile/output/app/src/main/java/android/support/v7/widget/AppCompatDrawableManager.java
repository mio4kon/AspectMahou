...
public final class AppCompatDrawableManager
{
  ...
  private void addTintListToCache(@NonNull Context paramContext, @DrawableRes int paramInt, @NonNull ColorStateList paramColorStateList)
  {
    ...
    SparseArray localSparseArray = (SparseArray)mTintLists.get(paramContext);
    if (localSparseArray == null)
    {
      localSparseArray = new SparseArray();
      mTintLists.put(paramContext, localSparseArray);
    }
  ...
  private Drawable loadDrawableFromDelegates(@NonNull Context paramContext, @DrawableRes int paramInt)
  {
    if ((mDelegates != null) && (!mDelegates.isEmpty()))
    {
      ...
      {
        String str2 = (String)mKnownDrawableIdTags.get(paramInt);
        if ((!"appcompat_skip_skip".equals(str2)) && ((str2 == null) || (mDelegates.get(str2) != null))) {
          break label81;
        }
        localDrawable = null;
      }
      for (;;)
      {
        ...
        if (localDrawable == null)
        {
          ...
          while (localDrawable == null)
          {
            ...
            mKnownDrawableIdTags.append(paramInt, str1);
            InflateDelegate localInflateDelegate = (InflateDelegate)mDelegates.get(str1);
