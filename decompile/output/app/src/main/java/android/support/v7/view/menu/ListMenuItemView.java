  ...
  implements MenuView.ItemView
{
  ...
  public ListMenuItemView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    mBackground = localTintTypedArray.getDrawable(R.styleable.MenuView_android_itemBackground);
    mTextAppearance = localTintTypedArray.getResourceId(R.styleable.MenuView_android_itemTextAppearance, -1);
    mPreserveIconSpacing = localTintTypedArray.getBoolean(R.styleable.MenuView_preserveIconSpacing, false);
    mTextAppearanceContext = paramContext;
    mSubMenuArrow = localTintTypedArray.getDrawable(R.styleable.MenuView_subMenuArrow);
