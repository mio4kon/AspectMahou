...
class AppCompatProgressBarHelper
{
  ...
  {
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes(mView.getContext(), paramAttributeSet, TINT_ATTRS, paramInt, 0);
    Drawable localDrawable1 = localTintTypedArray.getDrawableIfKnown(0);
    if (localDrawable1 != null) {
      mView.setIndeterminateDrawable(tileifyIndeterminate(localDrawable1));
    }
    Drawable localDrawable2 = localTintTypedArray.getDrawableIfKnown(1);
    if (localDrawable2 != null) {
      mView.setProgressDrawable(tileify(localDrawable2, false));
    }
