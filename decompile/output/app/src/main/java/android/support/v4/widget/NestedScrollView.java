  ...
  implements NestedScrollingParent, NestedScrollingChild, ScrollingView
{
  ...
  private boolean isWithinDeltaOfScreen(View paramView, int paramInt1, int paramInt2)
  {
    ...
    return (paramInt1 + mTempRect.bottom >= getScrollY()) && (mTempRect.top - paramInt1 <= paramInt2 + getScrollY());
  }
  ...
  protected int computeScrollDeltaToGetChildRectOnScreen(Rect paramRect)
  {
    ...
    do
    {
      ...
      if ((bottom > k) && (top > j))
      {
        ...
        for (int i1 = 0 + (top - j);; i1 = 0 + (bottom - k)) {
          return Math.min(i1, getChildAt(0).getBottom() - k);
        }
      }
    } while ((top >= j) || (bottom >= k));
    if (paramRect.height() > i) {}
    for (int n = 0 - (k - bottom);; n = 0 - (j - top)) {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (mEdgeGlowTop != null)
    {
      ...
      if (!mEdgeGlowTop.isFinished())
      {
        ...
        mEdgeGlowTop.setSize(i1, getHeight());
  ...
  protected void measureChildWithMargins(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramView.measure(getChildMeasureSpec(paramInt1, paramInt2 + (getPaddingLeft() + getPaddingRight() + leftMargin + rightMargin), width), View.MeasureSpec.makeMeasureSpec(topMargin + bottomMargin, 0));
  }
    ...
    for (;;)
    {
      ...
      if (k != -1)
      {
        ...
        else
        {
          ...
          if ((Math.abs(n - mLastMotionY) > mTouchSlop) && ((0x2 & getNestedScrollAxes()) == 0))
          {
            ...
            if (localViewParent != null)
            {
              ...
              else
              {
                ...
                boolean bool1 = mScroller.isFinished();
                boolean bool2 = false;
                if (!bool1) {
                  bool2 = true;
                }
                mIsBeingDragged = bool2;
                startNestedScroll(2);
                continue;
                mIsBeingDragged = false;
                mActivePointerId = -1;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    localView.measure(getChildMeasureSpec(paramInt1, getPaddingLeft() + getPaddingRight(), width), View.MeasureSpec.makeMeasureSpec(i - getPaddingTop() - getPaddingBottom(), 1073741824));
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        int n = (int)paramMotionEvent.getY(m);
        int i1 = mLastMotionY - n;
        if (dispatchNestedPreScroll(0, i1, mScrollConsumed, mScrollOffset))
        {
        ...
        int i2;
        int i3;
        if ((!mIsBeingDragged) && (Math.abs(i1) > mTouchSlop))
        {
        ...
        for (int i5 = 1;; i5 = 0)
        {
          ...
          if (!dispatchNestedScroll(0, i6, 0, i1 - i6, mScrollOffset)) {
            break label568;
          }
        ...
        if (i5 != 0)
        {
          ...
          if (i7 < 0)
          {
            mEdgeGlowTop.onPull(i1 / getHeight(), paramMotionEvent.getX(m) / getWidth());
            if (!mEdgeGlowBottom.isFinished()) {
              mEdgeGlowBottom.onRelease();
            }
          }
          while ((mEdgeGlowTop != null) && ((!mEdgeGlowTop.isFinished()) || (!mEdgeGlowBottom.isFinished())))
          {
            ...
            if (i7 > i3)
            {
              mEdgeGlowBottom.onPull(i1 / getHeight(), 1.0F - paramMotionEvent.getX(m) / getWidth());
              if (!mEdgeGlowTop.isFinished()) {
                mEdgeGlowTop.onRelease();
              }
            }
          ...
          if (mIsBeingDragged)
          {
            ...
            int k = (int)VelocityTrackerCompat.getYVelocity(localVelocityTracker, mActivePointerId);
  ...
  boolean overScrollByCompat(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean)
  {
    ...
    {
      if (bool2) {
        mScroller.springBack(i1, i2, 0, 0, 0, getScrollRange());
      }
  ...
  public boolean pageScroll(int paramInt)
  {
    ...
    if (paramInt == 130)
    {
      ...
      {
        View localView = getChildAt(k - 1);
        if (j + mTempRect.top > localView.getBottom()) {
  ...
  public final void smoothScrollBy(int paramInt1, int paramInt2)
  {
    ...
    if (AnimationUtils.currentAnimationTimeMillis() - mLastScroll > 250L)
    {
      ...
      mScroller.startScroll(getScrollX(), k, 0, m);
      ViewCompat.postInvalidateOnAnimation(this);
    }
    for (;;)
    {
