...
public final class ViewPropertyAnimatorCompat
{
    ...
    implements ViewPropertyAnimatorCompat.ViewPropertyAnimatorCompatImpl
  {
    ...
    {
      WeakHashMap localWeakHashMap = mStarterMap;
      Object localObject = null;
      if (localWeakHashMap != null) {
        localObject = (Runnable)mStarterMap.get(paramView);
      }
      if (localObject == null)
      {
    ...
    void startAnimation(ViewPropertyAnimatorCompat paramViewPropertyAnimatorCompat, View paramView)
    {
      ...
      Runnable localRunnable1 = mStartAction;
      Runnable localRunnable2 = mEndAction;
      mStartAction = null;
      mEndAction = null;
      ...
      implements ViewPropertyAnimatorListener
    {
      ...
      public void onAnimationEnd(View paramView)
      {
        ...
        if ((Build.VERSION.SDK_INT >= 16) || (!mAnimEndCalled))
        {
          ...
          {
            Runnable localRunnable = mVpa.mEndAction;
      ...
      public void onAnimationStart(View paramView)
      {
        ...
        {
          Runnable localRunnable = mVpa.mStartAction;
