  ...
  implements Parcelable
{
  ...
  public Object getPlaybackState()
  {
    ...
    if (localList != null)
    {
      localArrayList = new ArrayList(mCustomActions.size());
    ...
    if (Build.VERSION.SDK_INT >= 22) {}
    for (mStateObj = PlaybackStateCompatApi22.newInstance(mState, mPosition, mBufferedPosition, mSpeed, mActions, mErrorMessage, mUpdateTime, localArrayList, mActiveItemId, mExtras);; mStateObj = PlaybackStateCompatApi21.newInstance(mState, mPosition, mBufferedPosition, mSpeed, mActions, mErrorMessage, mUpdateTime, localArrayList, mActiveItemId)) {
      return mStateObj;
    }
  }
